...
class SaldoEstoqueAdmin(admin.ModelAdmin):
    list_display = ('estoque', 'material', 'saldo_fisico', 'saldo_reservado', 'saldo_disponivel', 'divergente')
...
class SaidaExcepcionalAdmin(admin.ModelAdmin):
    list_display = ('numero_publico', 'estoque', 'registrado_por', 'criado_em', 'estado')
...
class ImportacaoSCPIAdmin(admin.ModelAdmin):
    list_display = ('arquivo_nome', 'estoque', 'importado_por', 'importado_em', 'status', 'total_novos')
...
class MovimentacaoEstoqueAdmin(admin.ModelAdmin):
    list_display = ('tipo', 'material', 'estoque', 'delta_fisico', 'delta_reservado', 'criado_em')
